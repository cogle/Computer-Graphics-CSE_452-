...
public:
	...
	*/
	...
	const double  SHIFT_FACTOR = 0.0000001;
	/*
...
private:
	...
	void RayTrace(int & width, int & height, unsigned char* pixels);
	void createScene(const int & x, const int  & y, double & r, double & g, double & b, int depth);





	void rayToObject(const Vector3 ray, const Point3 point, DrawObject *& hitObject, Vector3 & n, Point3 & hit_point);

	void SceneLighting(const Vector3& ray, const Point3& point, double & r, double & g, double & b, int depth);
